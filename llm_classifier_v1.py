...
Ορισμός:
Ως Υποχρέωση Αναφοράς (Reporting Obligation – RO) ορίζεται η ρητά προβλεπόμενη από το δίκαιο υποχρέωση, βάσει της οποίας ένας καθορισμένος υπόχρεος ή ρυθμιζόμενος φορέας οφείλει 
να συλλέγει και να παρέχει, σε προκαθορισμένη μορφή, περιεχόμενο και χρονική συχνότητα, συγκεκριμένες πληροφορίες, δεδομένα, δηλώσεις ή εκθέσεις 
προς αρμόδια δημόσια, ρυθμιστική, εποπτική ή ελεγκτική αρχή ή προς θεσμικά πληροφοριακά συστήματα της διοίκησης, με σκοπό την άσκηση εποπτείας, την παρακολούθηση της συμμόρφωσης 
ή την εφαρμογή και επιβολή της νομοθεσίας.
